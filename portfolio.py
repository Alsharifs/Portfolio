...
with m_col2:
    st.markdown('<div class="metric-container"><div class="metric-value">24 times Faster</div><div class="metric-label">Recent Automation impact on business<br><small>24 times faster, from 4 minutes to 5 seconds</small></div></div>', unsafe_allow_html=True)
with m_col3:
