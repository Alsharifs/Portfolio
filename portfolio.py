...
with m_col4:
    st.markdown('<div class="metric-container"><div class="metric-value">Mastering Top Data Analysis Tools</div><div class="metric-label"><br><small>SQl, Advanced Excel includding VBA, Power BI</small></div></div>', unsafe_allow_html=True)
